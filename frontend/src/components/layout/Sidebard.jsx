  ...
  return (
    <aside className={styles.sidebar}>
      <ul className={styles.sidebar_list}>
        <li
          className={`${styles.sidebar_element} ${styles.sidebarelement_logo}`}
        >
          <img src={logo} alt="" className={styles.logo} />
          <div className={styles.sidebar_hide}>
            <p className={styles.sidebar_text}>ClearSales</p>
          </div>
        </li>
        <NavLink to={"/panel_inicio/inventario"} className={styles.NavLinks}>
          <li className={styles.sidebar_element}>
            ...
            <div className={styles.sidebar_hide}>
              <p className={styles.sidebar_text}>Productos</p>
            </div>
          </li>
        </NavLink>
        <NavLink to={"/panel_inicio/proveedores"} className={styles.NavLinks}>
          <li className={styles.sidebar_element}>
            <svg
              width="24"
              height="24"
            ...
            <div className={styles.sidebar_hide}>
              <p className={styles.sidebar_text}>Proveedores</p>
            </div>
          </li>
        </NavLink>
        <NavLink to={"/panel_inicio/movimientos"} className={styles.NavLinks}>
          <li className={styles.sidebar_element}>
            <svg
              width="24"
              height="24"
            ...
            <div className={styles.sidebar_hide}>
              <p className={styles.sidebar_text}>Movimientos</p>
            </div>
          </li>
        </NavLink>
        <li className={`${styles.sidebar_element} ${styles.exit_app}`}>
          <svg
            fill="#ffffff"
          ...
          <div className={styles.sidebar_hide}>
            <p className={styles.sidebar_text}>Cerrar Sesion</p>
          </div>
        </li>
      </ul>
    </aside>
